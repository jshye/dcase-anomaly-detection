...
def main(config, epoch):
    ...
    for dir_name in ["source_test", "target_test"]:
        ...
        for section_name in get_section_names(target_dir, dir_name=dir_name):
                    ...
                    for i in range(len(out)):
                        ...
                        if y[i] == 0:
                            ...
                            if normal_plot_cnt < 5:
                                ...
                                prob_fig = utils.plot_probability([0, 1, 2], normal_prob, normal_plot_cnt+1, anomaly=False, show=False)
                            ...
                            if anomaly_plot_cnt < 5:
                                ...
                                prob_fig = utils.plot_probability([0, 1, 2], anomaly_prob, anomaly_plot_cnt+1, anomaly=True, show=False)
            ...
            roc = utils.plot_roc(fpr, tpr, auc, show=False)
            ...
            fig = utils.plot_anomaly_score_distrib(normal_scores, abnormal_scores, epoch, decimals=2, show=False)
